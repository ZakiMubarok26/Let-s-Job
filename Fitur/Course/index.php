...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand " href="#"><img src="img/lets_job-removebg-preview.png" width="100px" height="100px" alt="Lets Job" /></a>
            <li><a href="Fitur/odfs/index.php">Discussion Forum</a></li>
            <li><a href="Fitur/CV_Template/CV/resume.html">CV Template</a></li>
            <li><a href="Fitur/Course/video.html">Course</a></li>
            <!--profile-->
            <dvi>
                <div class="dropdown">
                    <a href="#"
                    ...
                    <ul class="dropdown-menu shadow">
                        ...
                        <li><a class="dropdown-item" href="./pages/LoginCompany.php">Perushaaan</a></li>
                    </ul>
                </div>
            </dvi>
        </div>
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-left" tyle="color: blue;">
                        <h1><img class="img-fluid mt-3" src="img/lets_job__3_-removebg-preview.png" height="10px" alt="Lets Job" /></h1>
    ...
    <div class="container marketing p-3">
        ...
        <div class="row mt-4">
            <div class="col-lg-4" style="text-align: center;">
                ...
                <p class="text-center">At Lets Job, we understand that finding the right job can be a challenging
            ...
            <div class="col-md-7 d-flex align-items-center justify-content-cente">
                <div>
                    <h2 class="featurette-heading">Our Story : <span class="text-muted">Driven by Passion and
                            Purpose.</span></h2>
                    <p class="lead"> Lets Job was born out of a passion for connecting talented individuals with
    ...
    <footer class="bg-white p-4 text-muted ">
        <div class="container">
            ...
            <div class="d-flex flex-column align-items-center justify-content-cente mt-3">
                ...
                <!--copyrights-->
                <div class="d-flex">
                    <a class=" " href="#"><img src="img/lets_job-removebg-preview.png" width="58px" height="16px" alt="Lets Job"
                            class="mb-2" /></a>
